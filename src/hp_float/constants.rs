...
pub const E: HpFloat = HpFloat::new(27182818284590452353602874713527, 31);

/// The full circle constant (τ) = 2π. 32 digits of precision.
pub const TAU: HpFloat = HpFloat::new(62831853071795864769252867665590, 31);

/// The maximum value of an i128 representing an Aequa with scale 0.
pub const MAX: HpFloat = HpFloat::new(i128::MAX, 0);

/// The minimum value of an i128 representing an Aequa with scale 0.
pub const MIN: HpFloat = HpFloat::new(i128::MIN, 0);
